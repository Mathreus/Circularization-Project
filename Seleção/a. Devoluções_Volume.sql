SELECT
    ...
    SUM(CASE WHEN DESC_TIPO_OPERACAO LIKE '%DEVOLUCAO%' THEN QUANTIDADE ELSE 0 END) AS QTD_DEVOLUCOES,
    SUM(CASE WHEN DESC_TIPO_OPERACAO LIKE '%DEVOLUCAO%' THEN VALOR ELSE 0 END) AS VALOR_DEVOLUCOES,
    
    -- Cálculo 1: Devoluções por GRUPO (soma de todas as devoluções do grupo)
    SUM(CASE WHEN DESC_TIPO_OPERACAO LIKE '%DEVOLUCAO%' THEN QUANTIDADE ELSE 0 END) OVER (PARTITION BY GRUPO) AS DEVOLUCOES_POR_GRUPO,
    ...
    CASE 
        ...
        THEN ROUND(
            (SUM(CASE WHEN DESC_TIPO_OPERACAO LIKE '%DEVOLUCAO%' THEN QUANTIDADE ELSE 0 END) OVER (PARTITION BY GRUPO) * 100.0) / 
    ...
    CASE 
        ...
        THEN ROUND(
            (SUM(CASE WHEN DESC_TIPO_OPERACAO LIKE '%DEVOLUCAO%' THEN QUANTIDADE ELSE 0 END) * 100.0) / 
    ...
    CASE 
        WHEN SUM(CASE WHEN DESC_TIPO_OPERACAO LIKE '%DEVOLUCAO%' THEN QUANTIDADE ELSE 0 END) OVER (PARTITION BY GRUPO) > 0 
        THEN ROUND(
            (SUM(CASE WHEN DESC_TIPO_OPERACAO LIKE '%DEVOLUCAO%' THEN QUANTIDADE ELSE 0 END) * 100.0) / 
            SUM(CASE WHEN DESC_TIPO_OPERACAO LIKE '%DEVOLUCAO%' THEN QUANTIDADE ELSE 0 END) OVER (PARTITION BY GRUPO)
        , 2)
        ELSE 0 
